...
export const PROJECTS: Project[] = [
	{
		...
		link: ['www.', 'redditplayrust.com', '/stats'],
	...
	},
	{
		...
		link: ['www.', 'samplantmachinery.com'],
		colors: ['#ffc71e', '#11100e'],
		categories: ['projects'],
		description: (
			<>
				I don't only create things with no commercial viability, being able to{' '}
				<b>leverage AI</b> means I can{' '}
				<b>focus with more intent on the design</b> and create prototypes
				quickly. It also means I can then go in and spend extra time and care on{' '}
				<b>
					adding the bells and whistles that make the UX better for us humans
				</b>
				.
			</>
		),
	},
	{
		...
		link: ['www.', 'maiacomley.com'],
		colors: ['#f1f6df', '#ec6334'],
		categories: ['projects'],
		description: (
			<>
				My sister had just graduated, was back from travelling and was looking
				for a way to <b>showcase her work in marketing</b> - in a single day we
				sat down, and whipped up a nice looking portfolio website.
			</>
		),
	},
	{
		...
		name: 'Number Puzzle',
		path: '/number-chain',
		link: ['www.', 'haydns.website', '/number-chain'],
		colors: ['#bbeeef', '#122e2e'],
		categories: ['games'],
		description: (
			<>
				I made a really simple number based game years ago within <b>Unity</b>{' '}
				and took a weekend just to <b>port it over to the web</b>.
			</>
		),
	},
	{
		...
		name: 'Physics Type',
		path: '/physics-type',
		link: ['www.', 'haydns.website', '/physics-type'],
	...
	},
	{
		...
		path: '/vinyl-player',
		link: ['www.', 'haydns.website', '/vinyl-player'],
	...
	},
	{
		...
		link: ['www.', 'haydncomley.com'],
		colors: ['#ff595d', '#1f2121'],
		categories: ['projects', 'experiments'],
		description: (
			<>
				My ever changing personal website - I've always loved{' '}
				<b>productivity tools</b> and had an old University project laying
				around so I converted it into an <b>interactive portfolio</b>.
			</>
		),
	},
];
